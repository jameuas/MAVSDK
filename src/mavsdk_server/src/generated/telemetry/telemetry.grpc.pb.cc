...
static const char* TelemetryService_method_names[] = {
  ...
  "/mavsdk.rpc.telemetry.TelemetryService/SubscribeVehicleType",
...
TelemetryService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_SubscribeVehicleType_(TelemetryService_method_names[15], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
...
::grpc::ClientReader< ::mavsdk::rpc::telemetry::VehicleTypeResponse>* TelemetryService::Stub::SubscribeVehicleTypeRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeVehicleTypeRequest& request) {
  return ::grpc::internal::ClientReaderFactory< ::mavsdk::rpc::telemetry::VehicleTypeResponse>::Create(channel_.get(), rpcmethod_SubscribeVehicleType_, context, request);
}

void TelemetryService::Stub::async::SubscribeVehicleType(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeVehicleTypeRequest* request, ::grpc::ClientReadReactor< ::mavsdk::rpc::telemetry::VehicleTypeResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::mavsdk::rpc::telemetry::VehicleTypeResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_SubscribeVehicleType_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::mavsdk::rpc::telemetry::VehicleTypeResponse>* TelemetryService::Stub::AsyncSubscribeVehicleTypeRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeVehicleTypeRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::telemetry::VehicleTypeResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeVehicleType_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::mavsdk::rpc::telemetry::VehicleTypeResponse>* TelemetryService::Stub::PrepareAsyncSubscribeVehicleTypeRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeVehicleTypeRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::telemetry::VehicleTypeResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeVehicleType_, context, request, false, nullptr);
}
...
TelemetryService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::SERVER_STREAMING,
      new ::grpc::internal::ServerStreamingHandler< TelemetryService::Service, ::mavsdk::rpc::telemetry::SubscribeVehicleTypeRequest, ::mavsdk::rpc::telemetry::VehicleTypeResponse>(
          [](TelemetryService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::mavsdk::rpc::telemetry::SubscribeVehicleTypeRequest* req,
             ::grpc::ServerWriter<::mavsdk::rpc::telemetry::VehicleTypeResponse>* writer) {
               return service->SubscribeVehicleType(ctx, req, writer);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status TelemetryService::Service::SubscribeVehicleType(::grpc::ServerContext* context, const ::mavsdk::rpc::telemetry::SubscribeVehicleTypeRequest* request, ::grpc::ServerWriter< ::mavsdk::rpc::telemetry::VehicleTypeResponse>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
